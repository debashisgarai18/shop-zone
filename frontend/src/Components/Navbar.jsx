...
const TopHeader = () => {
  ...
  // function to handelSearch
  const handleSearchClick = () => {
    nav(`/landing?search=${searchOutput}`)
    setSearchOutput("")
  }
    ...
    <div className="w-[97%] flex item-center py-[1rem]">
      ...
      <div className="w-[45%] flex relative flex-row items-center">
        ...
        {/* <input
          ...
          placeholder="Search"
        /> */}
        <IoMdSearch className="text-[1.5rem] absolute right-[-42%] md:right-[32%] cursor-pointer" onClick={handleSearchClick}/>
      </div>
      <RightTopNav />
      {/* <HamburgerMenu /> */}
    </div>
